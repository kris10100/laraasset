...
<script src="{{ secure_asset('assets/js/extensions/export/bootstrap-table-export.js?v=1') }}"></script>
<script src="{{ secure_asset('assets/js/extensions/cookie/bootstrap-table-cookie.js?v=1') }}"></script>
