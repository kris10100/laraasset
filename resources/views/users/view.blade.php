      ...
      <div class="nav-tabs-custom">
        ...
        <div class="tab-content">
          ...
          <div class="tab-pane" id="files_tab">
            ...
            <link rel="stylesheet" type="text/css" href="{{ secure_asset('assets/css/lib/jquery.fileupload.css') }}">
            <link rel="stylesheet" type="text/css" href="{{ secure_asset('assets/css/lib/jquery.fileupload-ui.css') }}">
