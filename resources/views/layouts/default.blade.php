...
<html>
  <head>
    ...
    <link rel="stylesheet" href="{{ secure_asset('assets/js/plugins/iCheck/all.css') }}">
    ...
    <link rel="stylesheet" href="{{ secure_asset(elixir('assets/css/app.css')) }}">
  ...
  <body class="hold-transition skin-blue sidebar-mini sidebar-collapse">
    ...
    <script src="{{ secure_asset(elixir('assets/js/all.js')) }}"></script>
