...
<script src="{{ secure_asset('assets/js/bootstrap-table.js') }}"></script>
<script src="{{ secure_asset('assets/js/extensions/cookie/bootstrap-table-cookie.js') }}"></script>
<script src="{{ secure_asset('assets/js/extensions/mobile/bootstrap-table-mobile.js') }}"></script>
<script src="{{ secure_asset('assets/js/extensions/export/bootstrap-table-export.js') }}"></script>
<script src="{{ secure_asset('assets/js/extensions/export/tableExport.js') }}"></script>
<script src="{{ secure_asset('assets/js/extensions/export/jquery.base64.js') }}"></script>
<script src="{{ secure_asset('assets/js/extensions/multiple-sort/bootstrap-table-multiple-sort.js') }}"></script>
